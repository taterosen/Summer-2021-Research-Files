...
df = pd.read_csv('hiking-real-copy.csv')
#print(df.head(n=2))
"""
...
#df.dropna()
df = df[df['10832.953016337668'] < 1000000] # an avg of > 2.5m/s is probably not a hiking activity

print(df.info)
df.to_csv('hiking-real-copy2.csv')
